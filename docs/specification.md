...
<a href="#5">3. Загрузки прикрепленного к заявке файла из постоянной базы</a><br/>
<a href="#6">4. Работа с мерчантами</a><br/>
<a href="#7">5. Бэкап/восстановление данных таблиц сервисов и мест</a><br/>
<a href="#8">6. Работа с документами</a><br/>
<a href="#9">7. Работа с субъектами</a><br/>
<a href="#10">8. Предоставление и проверка доступа к документам</a><br/>
<a href="#11">9. Работа с сообщениями</a><br/>
<a href="#12">10. Работа с историей (Мой журнал)</a><br/>
<a href="#13">11. Аплоад(upload) и прикрепление файла в виде атачмента к таске Activiti</a><br/>
<a href="#14">12. Работа с каталогом сервисов</a><br/>
<a href="#15">13. Получение статистики по задачам в рамках бизнес процесса</a><br/>
<a href="#16">14. Работа с обьектами событий по услугам</a><br/>
<a href="#17">15. Работа со слотами потока</a><br/>
<a href="#18">16. Работа с джоинами суьтектами (отделениями/филиалами)</a><br/>
<a href="#19">17. Получение кнопки для оплаты через Liqpay</a><br/>
<a href="#20">18. Работа со странами </a><br/>
<a href="#21">19. Загрузка данных по задачам </a><br/>
<a href="#22">20. Получение списка бизнес процессов к которым у пользователя есть доступ </a><br/>
...
<a name="3">
<a href="#3"><h3>3. Загрузки прикрепленного к заявке файла из постоянной базы </h3></a><br/>
...
<a name="4">
<a href="#4"><h3>4. Работа с мерчантами </h3></a><br/>
</a><a href="#0_contents">↑Up</a><br/>
...
<a name="5">
<a href="#5"><h3>5. Бэкап/восстановление данных таблиц сервисов и мест</h3></a><br/>
</a><a href="#0_contents">↑Up</a><br/>
